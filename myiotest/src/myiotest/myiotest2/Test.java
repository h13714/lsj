...
public class Test {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("src/myiotest/myiotest2/name.txt"));
        String line;
        ...
        //7.把集合中的数据再次写到文件中
        BufferedWriter bw = new BufferedWriter(new FileWriter("src/myiotest/myiotest2/name.txt"));
        for (Student s : list) {
            bw.write(s.toString());
            bw.newLine();
        }
